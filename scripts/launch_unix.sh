...
docker run -it --rm --privileged --network=host -e DISPLAY=:0 -e LIBGL_ALWAYS_INDIRECT=0 -v /tmp/.X11-unix:/tmp/.X11-unix -v ~/.ssh:/home/ubuntu/.ssh -v $path:/home/ubuntu/hexacopter $id bash